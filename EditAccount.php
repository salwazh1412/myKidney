...
<div id="gtco-services">
    <div class="gtco-container">
            ...
            <div class="row animate-box">
                ...
                <h2 class= "text-center"; Style="color:gray; margin-top:-80px;"> Edit Account </h2>
...
<!---- start content_holder ----->
    ...
    <div class="content_holder">
             ...
             <div id="your-tab-id-1">
                    ...
                    <input width=100px type="text" class="myInput" id="myInput1" onkeyup="myFunction1()" placeholder="Search for names or phone number..">
                    ...
                    <?php
...

                                {
                                    ...
                                    // column 10
                                    echo "<td class='11' Style='text-align:center;'><a href='EditInformation.php?ID=".$row['User_ID']."&Type=3'><span class='icon-edit' Style = 'zoom: 1.5;'></a></span>";
                                    echo "</td>";	
            ...
            <div id="your-tab-id-2">
                              ...
                              <input width=100px type="text" id= "myInput2" class="myInput" onkeyup="myFunction2()" placeholder="Search for names or phone number..">
                    ...
                    <?php
...

                                {
                                    ...
                                    // column 10
                                    echo "<td class='22' Style='text-align:center;'><a href='EditInformation.php?ID=".$row['User_ID']."&Type=4'><span class='icon-edit' Style = 'zoom: 1.5;'></a></span>";
                                    echo "</td>";	
            ...
            <div id="your-tab-id-3">
                ...
                <input width=100px type="text" id="myInput3" class="myInput" onkeyup="myFunction3()" placeholder="Search for names..">
                    ...
                    <?php
...

                                {
                                    ...
                                    // column 4
                                    echo "<td class='33' Style='text-align:center;'><a href='EditInformation.php?ID=".$row['User_ID']."&Type=2'><span class='icon-edit' Style = 'zoom: 1.5;'></a></span>";
                                    echo "</td>";	
